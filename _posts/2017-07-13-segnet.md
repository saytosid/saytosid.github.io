...
1. ![](https://github.com/saytosid/segnet_docker_cs671/raw/master/videos/input.gif){:class="container"} ![](https://github.com/saytosid/segnet_docker_cs671/raw/master/videos/output.gif){:class="container"}   
2. ![](https://github.com/saytosid/segnet_docker_cs671/raw/master/videos/input2.gif){:class="container"} ![](https://github.com/saytosid/segnet_docker_cs671/raw/master/videos/output2.gif){:class="container"}  
3. ![](https://github.com/saytosid/segnet_docker_cs671/raw/master/videos/input3.gif){:class="container"} ![](https://github.com/saytosid/segnet_docker_cs671/raw/master/videos/output3.gif){:class="container"}  
...
![Complete architecture]({{site.baseurl}}/images/segnet/Complete architecture.png){:class="container"}
...
![encoder-decoder-blocks]({{site.baseurl}}/images/segnet/encoder-decoder-blocks.png){:class="container"}
<center>
...
![encoder_explained]({{site.baseurl}}/images/segnet/encoder_explained.png){:class="container"}
<center>
...
![upsampling]({{site.baseurl}}/images/segnet/upsampling.png){:class="container"}
<center>
...
![decoders_compared]({{site.baseurl}}/images/segnet/decoders_compared.png){:class="container"}  
<center>
